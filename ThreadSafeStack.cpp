...
public:
    ...
    void executeAtomicOperation(void (*callback)(ThreadSafeStack& stack))
    {
        /**
            ...
            since the stackMutex will be locked and operations within call back will tru to access it to => deadlock
        */
        // std::lock_guard<std::mutex> lock(this->stackMutex); //DEADLOCK!!!!!
